...
def get_model(input_img, n_filters=16):
    ...
    outputs = Conv2D(12, (1, 1), activation='softmax')(c11)
...
def display_mask(i):
    ...
    img = pillow.ImageOps.autocontrast(
...
if __name__ == "__main__":
    ...
    #callbacks = [ ModelCheckpoint('model-proba2.h5', verbose=1, save_best_only=True, save_weights_only=True)]

    #results = model.fit(train_gen, batch_size=batch_size, epochs=100, callbacks=callbacks, validation_data=(val_gen))
