...
if __name__ == "__main__":
    ...
    callbacks = [ ModelCheckpoint('model-relu-3.h5', verbose=1, save_best_only=True, save_weights_only=True)]

    results = model.fit(train_gen, batch_size=batch_size, epochs=300, callbacks=callbacks, validation_data=(val_gen))
